...
TweegestAction.prototype.getFriendIds = function (context) {

	this.tweegest.get('friends/ids', { screen_name: context.user, count: context.count || MAX_ID }, function(err, data) {
...
TweegestAction.prototype.getFriendObjects = function (context) {
	var self = this;
	...
	this.tweegest.get('friends/ids', { screen_name: context.user, count: context.count || MAX_ID }, function(err, data) {
		...
		self.tweegest.get('users/lookup', { user_id: idBlock }, function (err, data) {
...
TweegestAction.prototype.getVerifiedFriends = function (context) {
